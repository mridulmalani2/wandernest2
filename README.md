...
1. Point `NEON_DATABASE_URL` (or `DATABASE_URL`) at your Neon/Postgres instance so the seed writes to the correct database.
2. Run `node scripts/create-admin-user.js` to upsert the default admin into that database:
