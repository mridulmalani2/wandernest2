          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg prose-slate max-w-none">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 md:p-12 space-y-8">
                ...
                {/* Section 1 */}
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">1. Introduction and Acceptance of Terms</h2>
                ...
                {/* Section 2 */}
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Nature of the Platform and Services</h2>
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2.1 Marketplace Connector Model</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2.2 Independent Contractor Relationship</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">2.3 Platform Services Provided</h3>
                    <p>
                ...
                {/* Section 3 */}
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">3. User Eligibility and Account Registration</h2>
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">3.1 Age and Legal Capacity</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">3.2 Student Guide Additional Requirements</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">3.3 Account Security and Responsibility</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">3.4 Verification Process</h3>
                    <p>
                ...
                <section>
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">4.1 General Prohibitions</h3>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">4.2 Specific Prohibitions for Student Guides</h3>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">4.3 Specific Prohibitions for Tourists</h3>
                    <ul className="list-disc pl-6 space-y-2">
                ...
                {/* Section 5 */}
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Booking, Payments, and Transactions</h2>
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.1 Direct Transactions</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.2 Pricing and Payment Terms</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.3 Cancellations and Refunds</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">5.4 Tax Obligations</h3>
                    <p>
                ...
                <section>
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">6.1 No Warranties</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">6.3 User Responsibility</h3>
                    <p>
                ...
                <section>
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">8.1 Platform Ownership</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">8.2 Limited License</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">8.3 User Content License</h3>
                    <p>
                ...
                {/* Section 10 */}
                <section>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Data Protection and Privacy</h2>
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <p>
                ...
                <section>
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">11.2 Dispute Resolution Between Users</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">11.3 Disputes with TourWiseCo</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">11.4 EU Online Dispute Resolution</h3>
                    <p>
                      If you are a consumer based in the European Union, you may access the European Commission's online dispute resolution platform at: <a href="https://ec.europa.eu/consumers/odr" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr</a>
                    </p>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">12.1 Entire Agreement</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">12.2 Severability</h3>
                    <p>
                      If any provision of these Terms is found to be invalid, illegal, or unenforceable, the remaining provisions shall continue in full force and effect.
                    </p>

                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">12.3 Waiver</h3>
                    <p>
                      No waiver of any provision of these Terms shall be deemed a further or continuing waiver of such provision or any other provision.
                    </p>

                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">12.4 Assignment</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">12.5 Force Majeure</h3>
                    <p>
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">12.6 Third-Party Rights</h3>
                    <p>
                      These Terms do not confer any third-party beneficiary rights.
                    </p>

                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">12.7 Language</h3>
                    <p>
