...
export const metadata: Metadata = {
  ...
  description: 'Earn flexible income as a student guide. Share your city with travelers, set your own schedule, and make more than typical campus jobs. Join WanderNest today.',
  ...
  openGraph: {
    title: 'For Students - Become a Local Travel Guide | WanderNest',
    ...
    url: 'https://wandernest.vercel.app/student',
    images: [
      {
