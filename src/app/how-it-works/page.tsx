...
const FOUNDERS = [
  {
    ...
    image: 'https://media.licdn.com/dms/image/v2/D4D03AQHcJuGK2BUBvQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1723058389497?e=1740009600&v=beta&t=rZ0e3WcFvnIw1WmL0oT8bJW7kn0J0z0lFmHnCB1HSAY'
  },
  {
    name: 'Aditeya Arya',
    role: 'Co-Founder',
    ...
    image: 'https://media.licdn.com/dms/image/v2/D4D03AQFEjKMFOOY4qQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1727986626879?e=1740009600&v=beta&t=Jrl_n3R1DGKuN7Kv_1hNUxKpYprJ4tNFmThS8a8b60g'
  },
  {
    name: 'Ajinkya Kamble',
    role: 'Co-Founder',
    ...
    image: 'https://media.licdn.com/dms/image/v2/D4D03AQGRvK7UHv94Fg/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1709149063889?e=1740009600&v=beta&t=DvqCjpRqB9w0F3r8V6R1UvkCZ5qCaQHZ7v1hYZ3fPvI'
  }
]
              ...
              >
                {FOUNDERS.map((founder) => (
                  <motion.div
                    ...
                    variants={itemVariants}
                  >
                    <div className="relative backdrop-blur-lg bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-3xl p-6 text-center hover:border-white/30 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                      {/* Profile Image */}
                      ...
                      <p className="text-sm text-white/70 leading-relaxed mb-4">{founder.description}</p>
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-white/80 text-sm font-medium hover:bg-white/20 hover:text-white transition-all duration-200 border border-white/10 hover:border-white/20"
                      >
