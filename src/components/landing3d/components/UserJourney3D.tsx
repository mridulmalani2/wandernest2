        ...
        <div className="p-5 md:p-6">
          ...
          {isStudentCard && isActive && (
            <button
              ...
              className="inline-flex items-center gap-2 mt-3 px-5 py-2.5 rounded-full font-semibold text-sm transition-all duration-300 hover:scale-105 hover:shadow-lg"
              style={{
