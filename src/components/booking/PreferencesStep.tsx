        ...
        <div className="space-y-4">
          <div className="relative pb-6">
            ...
            >
              ...
              >
                <div className="h-10 border-l border-ui-blue-primary/50" />
                <div className="mt-1 rounded-full bg-white/80 px-2 py-1 text-[10px] text-gray-600 shadow-sm border border-gray-200">
